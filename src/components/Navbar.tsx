                ...
                <div className="px-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center justify-end gap-1">
                            <Link to="/cart" className="flex items-center justify-center gap-1 rounded-xl bg-white px-3 py-2 text-md font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 transition-all duration-150 hover:bg-gray-100 sm:inline-flex">
                                <FiShoppingCart className='text-purple-700 text-lg' /><span className='hidden sm:inline-flex mx-1'> &nbsp;Cart</span>
                                {
                                    totalItems ?
                                        <span className="flex items-center justify-center bg-brand-softer border border-brand-subtle text-fg-brand-strong text-purple-600 text-xs font-medium h-4 w-4 md:h-5 md:w-5 rounded-full">
